                    ...
                    <div class="group-chat">
                        ...
                        <div class="messages-container">
                            ...
                            <div class="messages">
                               ...
                               @else
                                <!-- Message to user -->
                                <div v-else class="message message-outgoing" style="flex-direction: row-reverse;">
                        ...
                        <!-- Message Input -->
                        <form action="{{ route('chat.store') }}" method="POST" class="message-input">
                            @csrf
                            <textarea  class="form-control" placeholder="Tapez votre message ici" name="message"></textarea>
